...
// This is a Javascript setInterval() method that will call the Run() function above every 200 milliseconds. 
setInterval(Run, 200);
...
function checkPageBounds(direction, imgWidth, pos, pageWidth) {
  //
  // This is to reverse direction upon hitting screen edge
  //
